...
describe('ServiceService', () => {
  ...
  describe('create', () => {
    it('should throw ConflictException if service already exists', async () => {
      ...
      mockServiceRepository.findOne.mockResolvedValue(new Service()); // Simular que el servicio ya existe
    ...
    it('should throw NotFoundException if user does not exist', async () => {
      ...
      mockServiceRepository.findOne.mockResolvedValue(null); // Simular que no se encuentra el usuario
    ...
    it('should create and return a service', async () => {
      ...
      mockServiceRepository.findOne.mockResolvedValue(null); // Simular que el servicio no existe
      mockUserRepository.findOne.mockResolvedValue(user); // Simular que el usuario existe
  ...
  describe('findAllByUserIdAndRole', () => {
    it('should return services for a user', async () => {
      ...
      mockUserRepository.findOne.mockResolvedValue(new User()); // Simular que el usuario existe
      mockServiceRepository.getMany.mockResolvedValue(expectedServices); // Simular que se obtienen los servicios
